...
int main(){
    ...
    cout<< "We worry about what a child will become tommorrow, yet we forget that he is someone today\n";
    ...
    cout<< "Childrena have never been very good at listening to their elders, but they have never failed to imitate them.\n";
    cout<< "Children are out most valuable resource.\n";
